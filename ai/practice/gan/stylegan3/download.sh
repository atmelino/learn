...
echo
echo 2. Open a browser at
echo https://drive.usercontent.google.com/download?id=16N0RV4fHI6joBuKbQAoG34V_cQk7vxSA&export=download
echo Download the file named ffhq-dataset-v2.json into the abovec created directory.
echo

...
options="--cfg=stylegan2 --gpus=2 --batch=8 --gamma=10 --mirror=1 --aug=noaug --kimg=200 --snap=1 --resume=../../../../../local_data/practice//stylegan3_betterdogs/output/00001-stylegan2-dogs-256x256-gpus2-batch8-gamma10/network-snapshot-000040.pkl"
